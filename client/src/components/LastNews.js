...
const LastNews = (parms)=>{
    ...
    return(
        <div className='flex flex-col justify-between items-center'>
            ...
            <div className='flex flex-row-reverse justify-between w-full h-[40vh] md:h-[20vh] bg-gray-100 rounded-lg'>
                ...
                <div className='flex justify-center items-center'>
                    <p className='text-sm text-center font-bold text-gray-600 md:text-md sm:text-xl'>{news}</p>
                </div>
